...
/* =========================================================
   إدارة تبديل المظهر (Light / Dark Mode)
   ========================================================= */
...
function applyTheme(isDark) {
  if (isDark) {
    ...
    localStorage.setItem("qutoof-theme", "dark");
    if (themeBtn) {
      themeBtn.innerHTML = `
        <svg viewBox="0 0 24 24" style="stroke:var(--honey-gold); fill:none; stroke-width:1.5;"><circle cx="12" cy="12" r="5"></circle><path d="M12 1v2M12 21v2M4.22 4.22l1.42 1.42M18.36 18.36l1.42 1.42M1 12h2M21 12h2M4.22 19.78l1.42-1.42M18.36 5.64l1.42-1.42"></path></svg>
      `;
    }
  } else {
    document.body.classList.remove("dark-mode");
    localStorage.setItem("qutoof-theme", "light");
    if (themeBtn) {
      themeBtn.innerHTML = `
        <svg viewBox="0 0 24 24" style="stroke:var(--honey-gold); fill:none; stroke-width:1.5;"><path d="M20.5 15.2A8.5 8.5 0 0 1 8.8 3.5 8.5 8.5 0 1 0 20.5 15.2Z"></path></svg>
      `;
    }
  }
}

// قراءة الوضع المحفوظ عند فتح الموقع (افتراضياً الوضع الفاتح أو حسب رغبة المشرف)
const savedTheme = localStorage.getItem("qutoof-theme");
if (savedTheme) {
